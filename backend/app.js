...
const app = express();
app.use(cors());
app.use(express.json());//this will parse all the data(name,email) in JSON format
...
mongoose
.connect("mongodb+srv://admin:V4YbgElwdyENkU6g@cluster0.wztdt.mongodb.net/Blog?retryWrites=true&w=majority"
)
